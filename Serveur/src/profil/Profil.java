...
public class Profil {
	...
	public static void Affiche_Profil() {
		Object[][] text = null;
		...
		ArrayList<String> l_prenom = new ArrayList<String>();
		ArrayList<String> l_profil = new ArrayList<String>();
		ArrayList<String> l_categorie = new ArrayList<String>();
		int index1 = 0;
		 try {
		      Class.forName("oracle.jdbc.driver.OracleDriver");
		      System.out.println("Driver O.K.");
			...
			while (rset.next()) {
				id_personne = rset.getString(1);
					l_id.add(id_personne);
					l_nom.add(rset.getString(2));
					l_prenom.add(rset.getString(3));
		 ...
		 GenerateurJSON.Ecriture_JSON(l_id, l_nom, l_prenom, l_profil, l_categorie);
			try {
	...
	@SuppressWarnings("null")
	public static void Affiche_Profil_One(int id) {
		Object[][] text = null;
		ArrayList<String> tmp_text = new ArrayList<String>();
		int index1 = 0;
		ArrayList<String> l_id = new ArrayList<String>();
	...
	public static void Action_Update_One(String profil_id) {
		Profil p;
		try {
				int id_profil = 0;
				try {
				    id_profil = Integer.parseInt(profil_id);
					p = new Profil(id_profil);
...
public static void Action_Show_One(String profil_id) {
	...
	public static void Action_Update_All() {
		Profil p;
		try {
				p = new Profil();
			} catch (SQLException e1) {
