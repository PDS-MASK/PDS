...
//					e1.printStackTrace();
//				}
				JSON.GenerateurJSON.Ecriture_JSON("ACHATS_BOUTIQUE","INDICATEUR",id_boutique.getText());
				try {
		        ...
		        String data  = LectureJSON.Get_Achats();
		        jour.setText(data + "€");
...
//					e1.printStackTrace();
//				}
				JSON.GenerateurJSON.Ecriture_JSON("ACHATS_BOUTIQUE_MOIS","INDICATEUR",id_boutique.getText());
				try {
					JSON.Client.Envoyer_Json();
				} catch (IOException e2) {
					// TODO Auto-generated catch block
